...
type Account struct {
	...
	// FallbackAccountID holds the value of the "fallback_account_id" field.
	FallbackAccountID *int64 `json:"fallback_account_id,omitempty"`
...
func (*Account) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case account.FieldID, account.FieldProxyID, account.FieldFallbackAccountID, account.FieldConcurrency, account.FieldLoadFactor, account.FieldPriority:
...
func (_m *Account) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case account.FieldFallbackAccountID:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				return fmt.Errorf("unexpected type %T for field fallback_account_id", values[i])
			} else if value.Valid {
				_m.FallbackAccountID = new(int64)
				*_m.FallbackAccountID = value.Int64
			}
...
func (_m *Account) String() string {
	...
	builder.WriteString(", ")
	if v := _m.FallbackAccountID; v != nil {
		builder.WriteString("fallback_account_id=")
		builder.WriteString(fmt.Sprintf("%v", *v))
	}
	builder.WriteString(", ")
