...
var (
	...
	AccountsColumns = []*schema.Column{
		...
		{Name: "fallback_account_id", Type: field.TypeInt64, Nullable: true},
	...
	AccountsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "account_fallback_account_id",
				Unique:  false,
	...
	UsageLogsColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt64, Increment: true},
		{Name: "failover_source_account_id", Type: field.TypeInt64, Nullable: true},
