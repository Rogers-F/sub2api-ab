...
func TestOpenAICodexPresetInstructionsMatchesPrettyAPIPromptForGPT56(t *testing.T) {
	account := &Account{
		Platform: PlatformOpenAI,
		Type:     AccountTypeAPIKey,
		Extra:    map[string]any{"openai_codex_preset_instructions": true},
	...
	require.True(t, injectOpenAICodexPresetInstructionsIntoMap(reqBody, account, "gpt-5.6-sol"))
