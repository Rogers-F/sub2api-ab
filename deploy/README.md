...
curl -sSL https://raw.githubusercontent.com/Rogers-F/sub2api-ab/main/deploy/docker-deploy.sh -o docker-deploy.sh
...
1. Download the latest release from [GitHub Releases](https://github.com/Rogers-F/sub2api-ab/releases)
