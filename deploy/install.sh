...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/Rogers-F/sub2api-ab/main/deploy/install.sh | bash
#
...
# Configuration
GITHUB_REPO="Rogers-F/sub2api-ab"
...
Documentation=https://github.com/Rogers-F/sub2api-ab
