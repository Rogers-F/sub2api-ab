<template>
  <section class="space-y-4 border-t border-gray-200 pt-4 dark:border-dark-600" data-testid="reasoning-effort-policy-fields">
    <div>
...
const maxEffortOptions = computed(() => [
  {
    value: "",
    label: t("admin.groups.form.maxReasoningEffortUnlimited"),
  },
