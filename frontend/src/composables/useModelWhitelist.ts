...
const openaiPresetMappings = [
  ...
  { label: 'GPT-5.5', from: 'gpt-5.5', to: 'gpt-5.5', color: 'bg-cyan-100 text-cyan-700 hover:bg-cyan-200 dark:bg-cyan-900/30 dark:text-cyan-400' },
...
const antigravityPresetMappings = [
  ...
  { label: 'Opus4.6→Opus', from: 'claude-opus-4-6*', to: 'claude-opus-4-6-thinking', color: 'bg-purple-100 text-purple-700 hover:bg-purple-200 dark:bg-purple-900/30 dark:text-purple-400' },
...
const bedrockPresetMappings = [
  ...
  { label: 'Sonnet 5', from: 'claude-sonnet-5', to: 'anthropic.claude-sonnet-5', color: 'bg-indigo-100 text-indigo-700 hover:bg-indigo-200 dark:bg-indigo-900/30 dark:text-indigo-400' },
