  ...
  admin: {
    ...
    groups: {
      ...
      form: {
        ...
        maxReasoningEffortHint: 'Limits explicit OpenAI reasoning effort requests only. Higher values are capped; omitted effort stays omitted.',
        ...
        reasoningEffortFromPlaceholder: 'Select request value',
        reasoningEffortToPlaceholder: 'Select forwarded value',
        fromRequired: 'Select a request value',
        toRequired: 'Select a forwarded value',
        ...
        duplicateFrom: 'Each request value can only be mapped once'
      },
    ...
    accounts: {
      ...
      balanceQuery: {
        ...
        sub2api: 'Sub2API',
        newapi: 'New API',
        hint: 'Query the upstream account wallet that owns this API Key, not the Key quota. Point Base URL to Sub2API or New API.',
        newapiHint: 'The New API account balance endpoint requires account-level credentials.',
        accessToken: 'Account Access Token *',
        accessTokenPlaceholder: 'New API account Access Token',
        accessTokenHint: 'Generate this Access Token in New API account settings. It is not the model API Key.',
        accessTokenEditHint: 'Leave empty to keep the current account Access Token.',
        userId: 'Account User ID *',
        userIdPlaceholder: 'For example: 1',
        userIdHint: 'The numeric New API account ID sent in the New-Api-User header.',
        accessTokenRequired: 'Enter the New API account Access Token',
        userIdRequired: 'Enter a valid New API account User ID',
        queryFailed: 'Query failed',
        unlimited: 'Unlimited'
      },
      ...
      openai: {
        ...
        stripImageGeneration: 'Strip image_generation tool',
        stripImageGenerationDesc:
          'When enabled, this account removes the Responses API image_generation tool and matching tool_choice before forwarding. Use it for accounts that should not send image generation requests.',
        ...
        codexPresetInstructions: 'Enable Codex preset Instructions',
        codexPresetInstructionsDesc:
          'For codex-* family models, automatically inject the built-in Codex system prompt when the request does not explicitly include instructions. Existing instructions are preserved.',
    ...
    usage: {
      ...
      allGroups: 'All Groups',
      allTypes: 'All Types',
      accountFailover: 'Account Failover',
      allAccountFailover: 'All',
      onlyAccountFailover: 'Account Failover Only',
      onlyNonAccountFailover: 'Non-Account Failover Only',
      ...
      ipAddress: 'IP',
      fallbackFromAccount: 'Fallback from {name}',
