  ...
  admin: {
    ...
    groups: {
      ...
      form: {
        ...
        maxReasoningEffortHint: '仅限制客户端主动请求的 OpenAI 推理强度；超过上限时自动降档，不会为缺省请求主动开启推理。',
        ...
        reasoningEffortFromPlaceholder: '请选择请求值',
        reasoningEffortToPlaceholder: '请选择转发值',
        fromRequired: '请选择请求值',
        toRequired: '请选择转发值',
        unsupportedFrom: '请求值不受当前平台支持',
        unsupportedTo: '转发值不受当前平台支持',
        duplicateFrom: '每个请求值只能映射一次',
        nameLabel: '分组名称',
    ...
    accounts: {
      ...
      balanceQuery: {
        ...
        sub2api: 'Sub2API',
        newapi: 'New API',
        hint: '查询 API Key 所属的上游账户余额，不读取 Key 自身额度。请将 Base URL 指向 Sub2API 或 New API。',
        newapiHint: 'New API 的账户余额接口需要账户级认证信息。',
        accessToken: '账户 Access Token *',
        accessTokenPlaceholder: 'New API 账户 Access Token',
        accessTokenHint: '在 New API 账户设置中生成的 Access Token，不是模型 API Key。',
        accessTokenEditHint: '留空则保留当前账户 Access Token。',
        userId: '账户 User ID *',
        userIdPlaceholder: '例如：1',
        userIdHint: 'New API 登录账户的数字用户 ID，用于 New-Api-User 请求头。',
        accessTokenRequired: '请输入 New API 账户 Access Token',
        userIdRequired: '请输入有效的 New API 账户 User ID',
        queryFailed: '查询失败',
        unlimited: '无限额度'
      },
    ...
    usage: {
      ...
      allGroups: '全部分组',
      allTypes: '全部类型',
      accountFailover: '账号兜底',
      allAccountFailover: '全部',
      onlyAccountFailover: '仅账号兜底',
      onlyNonAccountFailover: '仅非账号兜底',
      inputCost: '输入成本',
      outputCost: '输出成本',
